...
function SearchBar() {
  ...
  return (
    <>
      <div
        className="sm:w-[240px] max-w-[300px] h-[40px] border-[1.5px] border-[#bebebe] rounded-3xl flex items-center relative"
      ...
      >
        ...
        <input
          className="focus:outline-none mx-[10px] py-[3px] h-[30px] w-full sm:w-[240px]"
          type="text"
          id="userName"
        ...
        {isFocused &&
          searchUser.length > 0 &&
          (searchState.loading ? (
            <div className="bg-white h-[150px] w-[300px] sm:w-[240px] border-b rounded-b-2xl absolute top-[40px] shadow-md z-10 flex flex-col justify-center items-center">
